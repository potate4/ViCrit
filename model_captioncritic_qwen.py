...
multichoice_prompt = '''You are provided with an image and the description corresponding to this image. There is one hallucinations in this description. Find out the hallucination phase and answer with the hallucination phase directly in a list. Your output should only be a list that contains the hallucination phase you find. \n
Description: {} \n
'''
